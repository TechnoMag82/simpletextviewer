...
const QString FILE_CONFIG_EXT = ".syn";
...
const QString KEY_COMMENTS = "comments";
const QString KEY_COMMENTS_SINGLE_LINE = "comments_single";
const QString KEY_COMMENTS_BLOCK = "comments_block";
const QString KEY_OBJECTS = "objects";
const QString KEY_CONTROL_CHARACTERS = "control_characters";
const QString KEY_MACROS = "macros";
const QString KEY_PREPROCESSOR = "preprocessor";
const QString KEY_BRACES = "braces";
const QString KEY_STRINGS = "strings";
const QString KEY_CHARS = "chars";
